...
static const unsigned int gappoh         = gapall;  /* horiz outer gap between windows and screen edge */
static const unsigned int gappov         = gapall;  /* vert outer gap between windows and screen edge */
